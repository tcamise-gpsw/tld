...
export function ConnectorRelationshipView({ data, cardShadow: _cardShadow, onSelectRow }: ConnectorRelationshipViewProps) {
  ...
  const sourceNode: Node | null = data.sourceEl
    ? {
        id: String(data.sourceEl.id),
        type: 'elementNode',
        ...
        data: {
          ...
          element_id: data.sourceEl.id,
          position_x: origins.source.x,
          position_y: origins.source.y,
          name: data.sourceEl.name,
          description: data.sourceEl.description,
          kind: data.sourceEl.kind,
          technology: data.sourceEl.technology,
          url: data.sourceEl.url,
          logo_url: data.sourceEl.logo_url,
          technology_connectors: data.sourceEl.technology_connectors,
          tags: data.sourceEl.tags,
          repo: data.sourceEl.repo,
          branch: data.sourceEl.branch,
          file_path: data.sourceEl.file_path,
          language: data.sourceEl.language,
          has_view: data.sourceEl.has_view,
          view_label: data.sourceEl.view_label,
          links: [],
          parentLinks: [],
          onZoomIn: () => Promise.resolve(),
          onZoomOut: () => Promise.resolve(),
          onNavigateToDiagram: () => undefined,
          onSelect: () => onSelectRow(`element:${data.sourceEl.id}`),
  ...
  const targetNode: Node | null = data.targetEl
    ? {
        id: String(data.targetEl.id),
        type: 'elementNode',
        ...
        data: {
          id: data.targetEl.id,
          view_id: data.connector.view_id,
          element_id: data.targetEl.id,
          position_x: origins.target.x,
          position_y: origins.target.y,
          name: data.targetEl.name,
          description: data.targetEl.description,
          kind: data.targetEl.kind,
          technology: data.targetEl.technology,
          url: data.targetEl.url,
          logo_url: data.targetEl.logo_url,
          technology_connectors: data.targetEl.technology_connectors,
          tags: data.targetEl.tags,
          repo: data.targetEl.repo,
          branch: data.targetEl.branch,
          file_path: data.targetEl.file_path,
          language: data.targetEl.language,
          has_view: data.targetEl.has_view,
          view_label: data.targetEl.view_label,
          links: [],
          parentLinks: [],
          onZoomIn: () => Promise.resolve(),
          onZoomOut: () => Promise.resolve(),
          onNavigateToDiagram: () => undefined,
          onSelect: () => onSelectRow(`element:${data.targetEl.id}`),
          onInteractionStart: () => undefined,
          onConnectTo: () => Promise.resolve(),
          onRemove: () => Promise.resolve(),
          onHoverZoom: () => undefined,
