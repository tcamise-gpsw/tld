...
require (
	buf.build/gen/go/tldiagramcom/diagram/connectrpc/go v1.19.2-20260510134954-1dd1981cf3f6.1
	buf.build/gen/go/tldiagramcom/diagram/protocolbuffers/go v1.36.11-20260510134954-1dd1981cf3f6.1
